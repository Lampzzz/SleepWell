...
} from "../../services/redux/api/superAdminApiSlice";
...
const EditAdminAccount = () => {
  ...
  const { data, refetch } = useGetAdminDetailsQuery(id);
  const [updateAdminsAccount, { isLoading }] = useUpdateAdminsAccountMutation();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await updateAdminsAccount(formData).unwrap();
